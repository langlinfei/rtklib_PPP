                  ...
                  const double *R, int n, int m)
{
    ...
    trace(5, "filter x_:\n"); tracemat(5, x_, k, 1, 13, 4);
    trace(5, "filter P_:\n"); tracemat(5, P_, k, k, 13, 4);
    trace(5, "filter H_:\n"); tracemat(5, H_, k, m, 13, 4);
    info=filter_(x_,P_,H_,v,R,k,m,xp_,Pp_);

    trace(5, "filter_ xp_:\n"); tracemat(5, xp_, k, 1, 13, 4);
    trace(5, "filter_ Pp_:\n"); tracemat(5, Pp_, k, k, 13, 4);
...
{
    FILE *fp;
    const char* atxFile = { "D:\\Projects\\rtklib\\PPP\\data\\igs08.atx" };
    static const pcv_t pcv0={0};
    pcv_t pcv;
    double neu[3];
